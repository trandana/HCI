package com.example.rp.mycalender;
...
public class DBAdapter {
    ...
    public static final int COL_STIME = 2;
    public static final int COL_ETIME = 3;
    public static final int COL_DATE = 4;
    public static final int COL_REPEAT = 5;
    public static final int COL_DAY = 6;

    // [TO_DO_A4]
    // Update the ALL-KEYS string array
    public static final String[] ALL_KEYS = new String[] {KEY_ROWID,  KEY_TITLE, KEY_STIME, KEY_ETIME, KEY_DATE, KEY_REPEAT, KEY_DAY};
    ...
    public long insertRow(String title, String stime, String etime, String date, boolean repeat) {
        // [TO_DO_A8]
    ...
    //
    public long insertRow(String title, String stime, String etime, boolean repeat, int day) {
        // [TO_DO_A8]
        // Update data in the row with new fields.
        // Also change the function's arguments to be what you need!
        // Create row's data:
    ...
    public boolean updateRow(long rowId, String title, String stime, String etime, String date, boolean repeat, int day) {
        String where = KEY_ROWID + "=" + rowId;
