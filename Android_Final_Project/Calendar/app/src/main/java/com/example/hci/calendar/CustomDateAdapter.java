...
public class CustomDateAdapter extends AbsDateAdapter<CustomDateAdapter.CustomDateViewHolder> {
    ...
    static class CustomDateViewHolder extends AbsDateItemHolder {
        ...
        public void changeTextColor(boolean isSelected) {
            if (isSelected) {
                tvDay.setTextColor(resources.getColor(R.color.date_custom_item_day));
                ...
                tvDay.setTextColor(resources.getColor(R.color.date_item_day));
                tvDayName.setTextColor(resources.getColor(R.color.date_item_day_name));
                tvMonth.setTextColor(resources.getColor(R.color.date_item_month_name));
            }
        }
