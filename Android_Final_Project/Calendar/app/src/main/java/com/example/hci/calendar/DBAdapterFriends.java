...
public class DBAdapterFriends {
    /////////////////////////////////////////////////////////////////////

    // For logging:
    private static final String TAG = "DBAdapterFriend";
    ...
    public static final int COL_FRIENDS = 1;
    public static final int COL_TITLE = 2;
    public static final int COL_LOC = 3;
    public static final int COL_STIME = 4;
    public static final int COL_ETIME = 5;
    public static final int COL_DATE = 6;
    public static final int COL_REPEAT = 7;
    public static final int COL_DAY = 8;

    // [TO_DO_A4]
    // Update the ALL-KEYS string array
    public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_FRIEND, KEY_TITLE, KEY_LOC, KEY_STIME, KEY_ETIME, KEY_DATE, KEY_REPEAT, KEY_DAY};

    // [TO_DO_A5]
    // DB info: db name and table name.
    public static final String DATABASE_NAME = "FriendDb";
    public static final String DATABASE_TABLE = "Friends_Sched";
    ...
    public DBAdapterFriends(Context ctx) {
        this.context = ctx;
        myDBHelper = new DatabaseHelper(context);
    }

    // Open the database connection.
    public DBAdapterFriends open() {
    ...
    public long insertRow(String friend, String title, String loc, String stime, String etime, String date, boolean repeat) {
        // [TO_DO_A8]
    ...
    //
    public long insertRow(String friend, String title, String loc, String stime, String etime, boolean repeat, int day) {
        // [TO_DO_A8]
        // Update data in the row with new fields.
        // Also change the function's arguments to be what you need!
        // Create row's data:
    ...
    //Get row by friends name
    public Cursor getRowByName(String name) {
        String where = KEY_FRIEND + "=?";
    ...
    public Cursor getFriends() {
        String friends[] = {KEY_FRIEND};
        Cursor c = 	db.query(true, DATABASE_TABLE, friends,
                null, null, null, null, null, KEY_FRIEND+" ASC");
        if (c != null) {
            c.moveToFirst();
        }
        return c;
    ...
    public boolean updateRow(long rowId, String friend, String title, String loc, String stime, String etime, String date, boolean repeat, int day) {
        String where = KEY_ROWID + "=" + rowId;
        ...
        newValues.put(KEY_FRIEND, friend);
